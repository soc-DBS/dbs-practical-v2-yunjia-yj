...
-- AddForeignKey
ALTER TABLE "pre_requisite" ADD CONSTRAINT "pre_requisite_mod_code_fk" FOREIGN KEY ("modCode") REFERENCES "module"("mod_code") ON DELETE NO ACTION ON UPDATE NO ACTION;
